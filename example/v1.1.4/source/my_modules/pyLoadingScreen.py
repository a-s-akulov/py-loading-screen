        ...
        def _animation_geterator_RibbonDance(self):
            ...
            while True:
                ...
                for sectionId in range(sectionsCount):
                    ...
                    # Y-2
                    y12 = y11 - trigonometryCoef * workHight / 6
                    y22 = y21 + trigonometryCoef * workHight / 6
                    ...
                    # send lines
                    self._lines.append(((x, y11), (x, y12), {'color': color1}))
                    self._lines.append(((x, y21), (x, y22), {'color': color2}))
